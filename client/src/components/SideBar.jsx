...
const Sidebar = ({ logout }) => {
  ...
  const navLinks = [
    ...
    { path: '/textExtractorDemo', name: 'Text Extractor Demo'},
  ];
    ...
    >
      ...
      <div className="p-4 border-t dark:border-gray-700">
        <button
          ...
          className="flex items-center justify-center px-2 py-3 mb-2 text-gray-700 transition-colors rounded-3xl dark:text-gray-200 hover:bg-emerald-50 dark:hover:bg-emerald-900 hover:text-emerald-700 dark:hover:text-emerald-400"
        >
          {collapsed ? (
            darkMode ? (
              <Sun size={20} />
        ...
        <button
          onClick={logout}
          className="flex items-center px-2 py-3 text-red-600 transition-colors rounded-3xl dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900 hover:text-red-700 dark:hover:text-red-300"
        >
